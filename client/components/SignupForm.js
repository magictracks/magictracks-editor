...
module.exports = function (id, state, emit) {
  ...
  const onSubmit = function(e){
    ...
    emit("user:signup", formData);
  }

  return html `
  <form class="w-100 mt1" onsubmit=${onSubmit}>
  <input class="w-100 pa2 br2 ba b--dark-pink dark-pink" name="username" type="text" placeholder="username">
    ...
    <input class="pa2 mt2 br2 ba b--dark-pink dark-pink" type="submit" value="Sign up!">
  </form>  
  `
}
